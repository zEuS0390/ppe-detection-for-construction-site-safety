...
class ViolationDetails:
    ...
    total_helmet = Column(Integer)
    total_glasses = Column(Integer)
    total_vest = Column(Integer)
    total_gloves = Column(Integer)
    total_boots = Column(Integer)
    total_no_helmet = Column(Integer)
    total_no_glasses = Column(Integer)
    total_no_vest = Column(Integer)
    total_no_gloves = Column(Integer)
    total_no_boots = Column(Integer)
